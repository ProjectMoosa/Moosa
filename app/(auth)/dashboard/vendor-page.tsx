...
export default function VendorDashboardPage() {
  ...
  return (
    <Container>
      {/* Vendor-specific Warning Banner */}
      {vendor?.warningBanner && (
        <div className="mb-6 bg-yellow-100 border border-yellow-300 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-medium text-yellow-900">Payment Warning</h3>
              <p className="text-sm text-yellow-800 mt-1">{vendor.warningBanner}</p>
            </div>
          </div>
        </div>
      )}
      {/* Admin Banner */}
      {adminBanners && adminBanners.accountDisableWarning && (
        <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-700 mt-1">{adminBanners.bannerMessage}</p>
            </div>
          </div>
        </div>
      )}
